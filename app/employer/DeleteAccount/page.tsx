  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100 px-4">
      <div className="bg-white rounded shadow-lg p-6 w-full max-w-md">
        <h1 className="text-gray-800 text-xl font-bold mb-4 text-center">Delete Employer Account</h1>
        <button
          onClick={handleShow}
        ...
        {showConfirmation && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            <div className="relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-5 border w-96 shadow-lg rounded-md bg-white">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Confirm Account Deletion</h3>
